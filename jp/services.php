    ...
    <ul id="menu" class="mfb-component--bl mfb-zoomin" data-mfb-toggle="hover">
        <li class="mfb-component__wrap">
            ...
            <ul class="mfb-component__list">
                <li>
                    <a href="../en/services.php" data-mfb-label="English" class="mfb-component__button--child-en">
                    </a>
                </li>
                <li>
                    <a href="../kh/services.php" data-mfb-label="Khmer" class="mfb-component__button--child-kh">
                    </a>
                </li>
            </ul>
        </li>
            ...
            <div class="top-nav">
                <div class="top-nav-left">
                    <ul>
                        ...
                        <li class="active"><a href="services.php">サービス & 施設</a></li>
                ...
                <div class="specials">
                    ...
                    <div class="specials-grids">
                        <div class="special-grid">
                            ...
                            <a href="#"><img src="../images/Services_and_Facilities/image/conference.jpg" alt="conference room" title="Conference Room"></a>
                            <a href="#">会議室</a>
                            <p>セミナーやカンファレンス、ミーティングと言った様々な用途に応じてお使い頂けます。（現在建設途中）</p>
                        </div>
                        <div class="special-grid">
                            
                            <a href="detailsFacilities.php"><img src="../images/Services_and_Facilities/vkirirombus.jpg" alt="vkirirom bus" title="Shuttle Bus"></a>
                            <a href="detailsFacilities.php">シャトルバス</a>
                            <p>プノンペンーキリロム間（直行）のシャトルバスをご用意しております。</p>
                        </div>
                        <div class="special-grid spe-grid">
                            
                            <a href="#"><img src="../images/Services_and_Facilities/camping.JPG" alt="Camping" title="Camping"></a>
                            <a href="#">オートキャンプ</a>
                            <p>広々とした松の木々の中でオートキャンプがお楽しみ頂けます。通常のテントは５００張のご用意があり、１０００人が同時に宿泊する事が可能です。</p>
                        </div>
                        <div class="special-grid ">
                            
                            <a href="#"><img src="../images/Services_and_Facilities/image/BBQ.jpg" alt="delicious BBQ in vkirirom" title="BBQ"></a>
                            <a href="#">バーベキューセット</a>
                            <p>バーベキューセットのレンタルをご用意しております。メニューや人数などの質問やご不明な点などがございましたらお気軽に <span onclick="location='https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&source=mailto&to=info@vKirirom.com'">info@vKirirom.com</span> までお問い合わせください。</p>
                        </div>
                        <div class="special-grid ">
                            
                            <a href="#"><img src="../images/Services_and_Facilities/image/food.jpg" alt="nice Banquet in vkirirom" title="Banquet"></a>
                            <a href="#">パーティー</a>
                            <p>Pine View Kitchenでは最大１６０席のお座席をご用意しております。また、ビュッフェスタイルもご提供できます。</p>
                        </div>
                        <div class="special-grid spe-grid">
                            
                            <a href="#"><img src="../images/Activity/image/MortorBike_250c_.jpg" alt="Motorbike seeing view in vkirirom" title="MortorBike"></a>
                            <a href="#">レンタル</a>
                            <p>車やモーターバイク、又はマウンテンバイクに乗ってキリロムの絶景を楽しむのはいかがですか？ご利用の際はレセプションスタッフにお申し付けください。</p>
                            <div class="clear"> </div>
                        </div>
                        <div class="clear"> </div>
                    </div>

...
<body>
    ...
    <ul id="menu" class="mfb-component--bl mfb-zoomin" data-mfb-toggle="hover">
        <li class="mfb-component__wrap">
            ...
            <ul class="mfb-component__list">
                ...
                <li>
                    <a href="../kh/vkiriromCalendar.php" data-mfb-label="Khmer" class="mfb-component__button--child-kh">
                    </a>
                </li>
            </ul>
        </li>
            ...
            <div class="top-nav">
                <div class="top-nav-left">
                    <ul>
                        ...
                        <li class="active"><a href="vkiriromCalendar.php">カレンダ</a></li>
    ...
    <div class="content">
         ...
         <div class="gallerys">
            ...
            <div class="wrap">
                    <h3><em><strong>カレンダ</strong></em></h3>
                
<!--                    <Calendar Price of Our Resort -->

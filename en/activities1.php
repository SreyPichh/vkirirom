  ...
  <head>
	...
	<body>
      ...
      <li class="mfb-component__wrap">
        ...
        <ul class="mfb-component__list">
          <li>
            <a href="../jp/activities1.php" data-mfb-label="Japanese" class="mfb-component__button--child-jp"></a>
          </li>
          <li>
            <a href="../kh/activities1.php" data-mfb-label="Khmer" class="mfb-component__button--child-kh"></a>
          </li>
        </ul>
      </li>
    </ul>
    ...
    <!---End-header----->
		 ...
		 <div class="content">
		 		...
		 		<div class="wrap">
					...
					<div class="gallery-grids specials">
						<div class="gallery-grid">
							<a class="lightbox" data-littlelightbox-group="gallery" title="" href="../images/Activity/Camping.JPG"><img src="../images/Activity/Camping.JPG" alt="beautiful view camping in vkirirom natural resort of Cambodia"><span>View</span></a>
							<h4>CAMPING TOOLS</h4>
							<p>Tents are available for rent including mats, blankets and setting up.</p>
							<!--<div class="gallery-button"><a href="#">Read More</a></div>-->
						</div>
						<div class="gallery-grid grid2">
							<a class="lightbox" data-littlelightbox-group="gallery" title="" href="../images/Activity/BBQ.jpg"><img src="../images/Activity/BBQ.jpg" alt="delicious BBQ in vkirirom"><span>View</span></a>
							<h4>BBQ</h4>
							<p>We prepare BBQ set both for rental and for sale. Please contact us about details of number of people of your group and menu.</p>
							<!--<div class="gallery-button"><a href="#">Read More</a></div>-->
						</div>
				<!--		<div class="gallery-grid">
					...
					<!--	</div> -->
						<div class="gallery-grid">
							<a class="lightbox" data-littlelightbox-group="gallery" title="" href="../images/Activity/TreasureHunting.jpg"><img src="../images/Activity/TreasureHunting.jpg" alt="happy vkirirom natural resort acitivity TreasureHunting"><span>View</span></a>
							<h4>Treasure hunting</h4>
							<p>How good are you at reading and finding clues? Come and try our Treasure Hunting game and win an exciting prices in our century treasure.</p>
							<!--<div class="gallery-button"><a href="#">Read More</a></div>-->
						</div>
					...
					<div class="gallery-grids specials">
						<div class="gallery-grid">
							<a class="lightbox" data-littlelightbox-group="gallery" title="" href="../images/Activity/RopeClimbing.jpg"><img src="../images/Activity/RopeClimbing.jpg" alt="happy vkirirom natural resort acitivity robeclimbinb"><span>View</span></a>
							<h4>Rope climbing</h4>
							<p>Strap and buckle that harness and climb that rope.</p>
							<!--<div class="gallery-button"><a href="#">Read More</a></div>-->
						</div>
						<div class="gallery-grid grid2">
							<a class="lightbox" data-littlelightbox-group="gallery" title="" href="../images/Activity/Walkracing.JPG"><img src="../images/Activity/Walkracing.JPG" alt="happy vkirirom natural resort acitivity group walk racing"><span>View</span></a>
							<h4>Three legged race</h4>
							<p>A game of cooperation between partners as much as it is one of speed.</p>
							<!--<div class="gallery-button"><a href="#">Read More</a></div>-->
						</div>
						<!-- Centipede Race : Teamwork ! The aim of this game is to reach the finish and reach the line before any team does.-->
						<div class="gallery-grid">
							<a class="lightbox" data-littlelightbox-group="gallery" title="" href="../images/Activity/MortorBike(250c).jpg"><img src="../images/Activity/MortorBike(250c).jpg" alt="Motorbike rental to see view in vkirirom natural resort"><span>View</span></a>
							<h4>Motor bike rental（250cc）</h4>
							<p>Do you prefer riding a motor bike in 250cc to see the sights around vKirirom? You can rent the vehicles here, please ask the reception for more details. </p>
							<!--<div class="gallery-button"><a href="#">Read More</a></div>-->
            ...
            <div class="gallery-grids specials">
					   <div class="gallery-grid">
							<a class="lightbox" data-littlelightbox-group="gallery" title="" href="../images/Activity/Chambok.JPG"><img src="../images/Activity/Chambok.JPG" alt="memory activity to chombok water fall from vkirirom"><span>View</span></a>
							<h4>Chambok Water Fall Tour</h4>
							<p>Join our Chambok water fall tour and experience the magnificent beauty of the fall as well as the native around.</p>
							<!--<div class="gallery-button"><a href="#">Read More</a></div>-->
						</div>
						<div class="gallery-grid grid2">
							<a class="lightbox" data-littlelightbox-group="gallery" title="" href="../images/Activity/JungleTrekking.jpg"><img src="../images/Activity/JungleTrekking.jpg" alt="happy vkirirom natural resort acitivity jungle trekking"><span>View</span></a>
							<h4>JUNGLE TREKKING</h4>
							<p> Jungle treks can be taken throughout the year. In the green season when rain is plentiful the forest is awash with lush.</p>
							<!--<div class="gallery-button"><a href="#">Read More</a></div>-->
						</div>
						<div class="gallery-grid">
							<a class="lightbox" data-littlelightbox-group="gallery" title="" href="../images/Activity/Cambodia_BuddhistTemple.png"><img src="../images/Activity/Cambodia_BuddhistTemple.png" alt="Historical place of cambodia in vkirirom natural resort"><span>View</span></a>
							<h4>HALF DAY SIGHTSEEING TOUR</h4>
							<p>We will show you around the Kirirom National Park, including king Sihanouk's royal palace ruins.</p>
							<!--<div class="gallery-button"><a href="#">Read More</a></div>-->
						</div>
						<div class="clear"> </div>
					</div>
          ...
          <div class="gallery-grids specials">
						<div class="gallery-grid">
							<a class="lightbox" data-littlelightbox-group="gallery" title="" href="../images/Activity/BubbleRental.jpg"><img src="../images/Activity/BubbleRental.jpg" alt="customer bubble rental in vkirirom"><span>View</span></a>
							<h4>Bubble rental</h4>
							<p>Let's go bouncing ... Try one of these bubbles and race with your friends or anything as you wish.</p><br>
							<!--<div class="gallery-button"><a href="#">Read More</a></div>-->
						</div>
						<div class="gallery-grid grid2">
